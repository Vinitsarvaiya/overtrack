...
import type { PermissionRow } from "@/features/roles/lib/permissions";
...
import {
  ...
  renameRole,
  setRolePermission,
} from "@/features/roles/api/roles.functions";
import { type WorkspaceRole } from "@/features/roles/types";
  ...
  return {
    ...
    toggle: useMutation({
      ...
      onMutate: async (input) => {
        ...
        const previousPermissions = queryClient.getQueryData<Record<string, string[]>>(queryKey);
