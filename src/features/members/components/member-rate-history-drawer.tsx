...
import { useMemberRateHistory } from "@/features/members/hooks/use-members";
                  ...
                  <p className="text-sm text-muted-foreground">
                    <span className="line-through">
                      {record.old_value === null
                        ? "Default"
                        : formatRate(Number(record.old_value), currency)}
                    </span>
                    {" -> "}
                    <span className="text-foreground">
                      {record.new_value === null
                        ? "Default"
                        : formatRate(Number(record.new_value), currency)}
                    </span>
                  </p>
